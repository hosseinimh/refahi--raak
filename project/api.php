...
Route::post('/equipmentplace/add', [PlaceEquipmentController::class, 'add']);
Route::post('/equipmentplace/save', [PlaceEquipmentController::class, 'save']);
Route::get('/equipmentplace/delcat', [PlaceEquipmentController::class, 'delete']);
Route::get('/equipmentplace/changecat', [PlaceEquipmentController::class, 'change']);
