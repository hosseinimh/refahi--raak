...

{
   ...
   public function save(Request $request)
   {
    ...
    //             ]);
     ...
     {
        $i++;
        $frmData['eqm_id'] = $equipment['id'];
        $frmData['eqm_title'] = $equipment['title'];
...
return response()->json(['_result' => '1', '_message' => 'تجهیزات ملک iman با موفقیت اضافه شد']);
