    ...
    var SimpleBarCore = /** @class */ (function () {
        ...
        SimpleBarCore.prototype.initDOM = function () {
            ...
            if (!this.options.autoHide) {
                (_d = this.axis.x.scrollbar.el) === null || _d === void 0 ? void 0 : _d.classList.add(this.classNames.visible);
                (_e = this.axis.y.scrollbar.el) === null || _e === void 0 ? void 0 : _e.classList.add(this.classNames.visible);
            }
