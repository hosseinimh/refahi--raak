...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var SimpleBar = React__namespace.forwardRef(function (_a, ref) {
        ...
        var options = {};
        var rest = {};
        var scrollableNodeFullProps = __assign(__assign({}, scrollableNodeProps), { className: "simplebar-content-wrapper".concat(scrollableNodeProps.className ? " ".concat(scrollableNodeProps.className) : ''), tabIndex: 0, role: 'region', 'aria-label': options.ariaLabel || SimpleBarCore.defaultOptions.ariaLabel });
        ...
        return (React__namespace.createElement("div", __assign({ ref: elRef }, rest),
            React__namespace.createElement("div", { className: "simplebar-wrapper" },
                React__namespace.createElement("div", { className: "simplebar-height-auto-observer-wrapper" },
                    React__namespace.createElement("div", { className: "simplebar-height-auto-observer" })),
                React__namespace.createElement("div", { className: "simplebar-mask" },
                    React__namespace.createElement("div", { className: "simplebar-offset" }, typeof children === 'function' ? (children({
                        ...
                        React__namespace.createElement("div", { className: "simplebar-content" }, children))))),
                React__namespace.createElement("div", { className: "simplebar-placeholder" })),
            React__namespace.createElement("div", { className: "simplebar-track simplebar-horizontal" },
                React__namespace.createElement("div", { className: "simplebar-scrollbar" })),
            React__namespace.createElement("div", { className: "simplebar-track simplebar-vertical" },
                React__namespace.createElement("div", { className: "simplebar-scrollbar" }))));
    });
